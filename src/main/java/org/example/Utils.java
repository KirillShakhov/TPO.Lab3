...
public class Utils {
    ...
    public static final String CORRECT_LOGIN = "kirill_shakhov";
    public static final String DISPLAY_NAME = "kirill1";
    public static final String CORRECT_PASSWORD = "itmoitmo";
    public static final String WRONG_PASSWORD = "ifmoifmo";
